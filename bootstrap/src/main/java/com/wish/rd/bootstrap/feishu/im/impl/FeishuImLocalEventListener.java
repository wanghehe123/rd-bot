package com.wish.rd.bootstrap.feishu.im.impl;
...
public class FeishuImLocalEventListener implements SmartLifecycle {
    ...
    public boolean shouldStopAfterExit(int exitCode, List<String> stderrLines) {
        if (exitCode != 2) {
            return false;
        }
    ...
    public void handleEventLine(String line) {
    ...
    public String toHttpEnvelope(String line) throws Exception {
