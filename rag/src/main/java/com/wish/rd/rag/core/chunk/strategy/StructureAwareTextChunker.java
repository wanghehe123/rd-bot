package com.wish.rd.rag.core.chunk.strategy;

import com.wish.rd.rag.core.chunk.ChunkingMode;
import com.wish.rd.rag.core.chunk.ChunkingOptions;
import com.wish.rd.rag.core.chunk.ChunkingStrategy;
import com.wish.rd.rag.core.chunk.TextBoundaryOptions;
 ...
 *
 * <p>这是 /rag/v3/chat 默认文档（payment-api.md）使用的分块方式，比纯定长切分更友好：
 * <ol>
